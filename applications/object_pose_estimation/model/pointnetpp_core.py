...
#         self.sa1 = PointNetSetAbstraction(256, 0.08, 32, 6, [32, 32, 64], False)
#         self.sa2 = PointNetSetAbstraction(128, 0.16, 32, 64 + 3, [64, 64, 128], False)
#         self.sa3 = PointNetSetAbstraction(64, 0.32, 32, 128 + 3, [128, 128, 256], False)
#         self.sa4 = PointNetSetAbstraction(32, 0.64, 32, 256 + 3, [256, 256, 512], False)
