...
class PointPP(nn.Module):
    def __init__(self):
        ...
        self.sa1 = PointNetSetAbstraction(2048, 0.05, 32, 6, [32, 32, 64], False)
        self.sa2 = PointNetSetAbstraction(1024, 0.1, 64, 64 + 3, [64, 64, 128], False)
        self.sa3 = PointNetSetAbstraction(512, 0.2, 128, 128 + 3, [128, 128, 256], False)
        self.sa4 = PointNetSetAbstraction(256, 0.4, 256, 256 + 3, [256, 256, 512], False)
